...
object Lesson07 {
    val lesson = Lesson(
        ...
        vocabulary = listOf(
            ...
            VocabItem(japanese = "ラーメン", romaji = "Ra-men", hebrew = "ראמן", emoji = "🍜"),
            VocabItem(japanese = "そば", romaji = "Soba", hebrew = "אטריות סובה", emoji = "🍝"),
            VocabItem(japanese = "にく", romaji = "Niku", hebrew = "בשר", emoji = "🥩"),
            VocabItem(japanese = "おいしい", romaji = "Oishii", hebrew = "טעים", emoji = "😋"),
